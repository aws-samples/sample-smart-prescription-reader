...
export interface ExtractPrescriptionProps {
...
export class ExtractPrescription extends lambda.Function {
  constructor(scope: Construct, id: string, props: ExtractPrescriptionProps) {
    const configParam = '/ExtractPrescriptionLambdaConfig';

    const extractPrescriptionLogs = new logs.LogGroup(
      scope,
      'ExtractPrescriptionLogs',
      {
    ...
    super(scope, id, {
      ...
      handler:
        'smart_prescription_reader.lambda_handlers.extract_prescription.handler',
      ...
      logGroup: extractPrescriptionLogs,
    });
    ...
    new CfnOutput(this, 'ExtractPrescriptionLambdaConfig', {
