...
export interface CorrectResponseProps {
...
export class CorrectResponse extends lambda.Function {
  constructor(scope: Construct, id: string, props: CorrectResponseProps) {
    const configParam = '/CorrectResponseLambdaConfig';

    const correctResponseLogs = new logs.LogGroup(
      scope,
      'CorrectResponseLogs',
      {
    ...
    super(scope, id, {
      ...
      handler:
        'smart_prescription_reader.lambda_handlers.correct_response.handler',
    ...
    new CfnOutput(this, 'CorrectResponseLambdaConfig', {
