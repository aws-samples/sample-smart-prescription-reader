...
class TestDrugInformation:
    ...
    def test_valid_initialization(self):
        ...
        drug_info = DrugInformation(
            drug_name="Lisinopril", active_ingredient="Lisinopril", strength="10 mg", form="Tablet"
        )
    ...
    def test_initialization_with_empty_strings(self):
        ...
        drug_info = DrugInformation(drug_name="", active_ingredient="", strength="", form="")
    ...
    def test_model_json_serialization(self):
        ...
        drug_info = DrugInformation(
            drug_name="Amoxicillin", active_ingredient="Amoxicillin", strength="250 mg/5 mL", form="Oral Suspension"
        )
